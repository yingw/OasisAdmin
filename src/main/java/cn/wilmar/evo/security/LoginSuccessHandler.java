...
import static cn.wilmar.evo.config.DataLoader.DEFAULT_ADMIN;
import static cn.wilmar.evo.config.DataLoader.DEFAULT_ADMIN_ROLE_NAME;
import static cn.wilmar.evo.config.DataLoader.DEFAULT_USER_ROLE_NAME;
...
public class LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    private static boolean isUserAdmin(User user) {
        for (GrantedAuthority authority : user.getAuthorities()) {
            if (authority.getAuthority().equals("ROLE_" + DEFAULT_ADMIN)) {
                return true;
            }
        }
        return false;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
        ...
        request.getSession().setAttribute(USER_ROLE_NAME, isUserAdmin(userDetails) ? DEFAULT_ADMIN_ROLE_NAME : DEFAULT_USER_ROLE_NAME);
